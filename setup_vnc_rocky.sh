#!/bin/bash
# VNC Server with noVNC Setup Script for Rocky Linux
...
DISPLAY=:$DISPLAY_NUM xterm -geometry 80x24+10+10 -title "VNC Test Terminal - Rocky Linux" -e "echo 'Welcome to VNC Server on Rocky Linux!' && echo 'This terminal is running in a VNC session.' && echo '' && echo 'Press Ctrl+C to exit' && cat" &
sleep 1
...
# Rocky Linux installs noVNC in /usr/share/novnc
